...
function start() {
  ...
  const gameOver = () => {
    endScreen.innerHTML = `<div class="gameOver">Perdu, Dommage... <br/>Score : ${count} </div>`;
  ...
  const youWin = () => {
    ...
    endScreen.innerHTML = `<div class="youWin">Bien joué ! Tu as vaincu ce virus avec ${accuracy}% de précision</span></div>`;
    endScreen.style.visibility = 'visible';
    endScreen.style.opacity = '1';
    loopPlay = false; 
  };
